...
const logger = new _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["Logger"]('TOTP');
const AmplifyTOTPSetup = class {
    ...
    async componentWillLoad() {
         ...
         */
        this.removeHubListener = Object(_helpers_4afef5ab_js__WEBPACK_IMPORTED_MODULE_6__["o"])(authState => {
    ...
    async onTOTPEvent(event, data, user) {
        ...
        if (event === _constants_d1abe7de_js__WEBPACK_IMPORTED_MODULE_5__["S"] && data === _constants_d1abe7de_js__WEBPACK_IMPORTED_MODULE_5__["i"]) {
    ...
    async setup() {
        ...
        if (!this.user || this.user.challengeName !== 'MFA_SETUP' || this.loading)
            return;
        this.setupMessage = null;
        const encodedIssuer = encodeURI(_aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.issuer));
        ...
        this.loading = true;
        try {
            const secretKey = await _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_3__["Auth"].setupTOTP(this.user);
            ...
            Object(_helpers_4afef5ab_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error);
            logger.debug(_aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_4__["T"].TOTP_SETUP_FAILURE), error);
        }
        finally {
            this.loading = false;
        }
    ...
    async verifyTotpToken(event) {
        ...
        try {
            await _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_3__["Auth"].verifyTotpToken(user, this.qrCodeInput);
            await _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_3__["Auth"].setPreferredMFA(user, _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["M"].TOTP);
            ...
            await this.onTOTPEvent(_constants_d1abe7de_js__WEBPACK_IMPORTED_MODULE_5__["S"], _constants_d1abe7de_js__WEBPACK_IMPORTED_MODULE_5__["i"], user);
        }
        catch (error) {
