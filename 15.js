...
const AmplifyButton = class {
    constructor(hostRef) {
        ...
        this.handleClick = (ev) => {
            ...
            else if (Object(_helpers_4afef5ab_js__WEBPACK_IMPORTED_MODULE_6__["e"])(this.el) && this.type == 'submit') {
    ...
    render() {
        return (Object(_index_3fb5c139_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { class: {
                [this.variant]: true,
            }, type: this.type, disabled: this.disabled, onClick: this.handleClick }, this.variant === 'icon' && Object(_index_3fb5c139_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-icon", { name: this.icon }), Object(_index_3fb5c139_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null)));
    }
